...
class MySQLDatabase 
{
  ...
  public function find_all_record()
  {
	...
	public function find_all_record_description($action)
  {
    $sql = "SELECT description FROM record WHERE name='$action'";
    $record_set = mysqli_query($this->connection, $sql);
	  return $record_set;
	} 
  ...
  {
    $sql = "SELECT description FROM social_links WHERE record_name='$action'";
  ...
  {
    $sql = "SELECT description FROM study_material WHERE record_name='$action'";
